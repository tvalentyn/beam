 ...
 * }</pre>
 *
 * <p>NOTE: When using {@link ContextualTextIO.Read#withHasMultilineCSVRecords(Boolean)},
 * a single reader will be used to process the file, rather than multiple readers which can
 ...
 * pipeline. By default withRecordNumMetadata is set to false, in this case record objects still
 * contain recordNums, but these recordNums correspond to their relative positions in respective
 * offsets rather than their positions within the entire file).
 *
